...
import com.ekrishibazaar.adapter.SliderAdapterExample;
import com.ekrishibazaar.model.SliderItem;
import com.ekrishibazaar.util.PrefsHelper;
...
public class ViewMyOfferAdsActivity extends AppCompatActivity {
    ...
    TextView additional_info_tv, vid_tv, mobile_number_tv, joined_tv, state_tv, district_tv, block_tv, village_tv, product_name_tv, product_breed_tv, product_status_tv,
            product_quantity_tv, packing_avialable_tv, price_tv, no_record_tv,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_my_offer_ads);
        init();
    }
        ...
        back_image.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ViewMyOfferAdsActivity.super.onBackPressed();
                    }
                }
        );
...
//                || category.equals("Flower") || category.equals("oilseeds") || category.equals("agricultural")) {
//
...
//        }
    ...
    private void getAdsType(String post_id) {
        ...
        String url = "https://ekrishibazaar.com/api/ads/filterads/?postid=" + post_id;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            mProgressDialog.dismiss();
                            JSONArray data_array = x.getJSONArray("results");
                            if (data_array.length() > 0) {
                                JSONObject obj = data_array.getJSONObject(0);
                                String ads_type = obj.getString("type");
                                if (ads_type.equals("agriculturalads")) {
                                ...
                                } else if (ads_type.equals("cattleads")) {
                                ...
                                } else if (ads_type.equals("fertilizerandpestisidesads")) {
                                    agricultural_ads_linear.setVisibility(View.GONE);
                                    cattle_ads_linear.setVisibility(View.GONE);
                                    labourInrent_linear.setVisibility(View.GONE);
                                    agricultural_machinary_ads_linear.setVisibility(View.GONE);
                                ...
                                } else if (ads_type.equals("labourinrentads")) {
                                    agricultural_ads_linear.setVisibility(View.GONE);
                                    cattle_ads_linear.setVisibility(View.GONE);
                                ...
                                } else if (ads_type.equals("machinaryads")) {
                                    agricultural_ads_linear.setVisibility(View.GONE);
                                    cattle_ads_linear.setVisibility(View.GONE);
                                    labourInrent_linear.setVisibility(View.GONE);
                                    fertilizer_linear.setVisibility(View.GONE);
                                ...
                                } else if (ads_type.equals("otheragriads")) {
                                    agricultural_ads_linear.setVisibility(View.GONE);
                                    cattle_ads_linear.setVisibility(View.GONE);
                                    labourInrent_linear.setVisibility(View.GONE);
                                    fertilizer_linear.setVisibility(View.GONE);
                                ...
                                } else if (ads_type.equals("serviceinrentads")) {
                                    agricultural_ads_linear.setVisibility(View.GONE);
                                    cattle_ads_linear.setVisibility(View.GONE);
                                    labourInrent_linear.setVisibility(View.GONE);
                                    fertilizer_linear.setVisibility(View.GONE);
                                ...
                                } else if (ads_type.equals("treeandwoodsads")) {
                                    agricultural_ads_linear.setVisibility(View.GONE);
                                    cattle_ads_linear.setVisibility(View.GONE);
                                    labourInrent_linear.setVisibility(View.GONE);
                                    fertilizer_linear.setVisibility(View.GONE);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (data_array.length() > 0) {
                                ...
                                if (product_obj.getString("product_name") != null && !product_obj.getString("product_name").equals("")) {
                                ...
                                packing_avialable_tv.setText(obj.getString("product_packaging_available"));
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (data_array.length() > 0) {
                                ...
                                if (cattle_type_obj.getString("cattle_name") != null && !cattle_type_obj.getString("cattle_name").equals("")) {
                                    scrollview.setVisibility(View.VISIBLE);
                                }
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (data_array.length() > 0) {
                                ...
                                String category_name = category_obj.getString("category_name");
                                if (chemical_product_obj.getString("chemical_product_name") != null && !chemical_product_obj.getString("chemical_product_name").equals("")) {
                                    scrollview.setVisibility(View.VISIBLE);
                                }
    ...
    private void getLabourAdsDetails(String post_id) {
        ...
        mProgressDialog.show();
        String url;
        url = "https://ekrishibazaar.com/api/ads/filterads/?postid=" + post_id;
        StringRequest postRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (data_array.length() > 0) {
                                ...
                                if (labour_expertiset_obj.getString("expertise") != null && !labour_expertiset_obj.getString("expertise").equals("")) {
                                    scrollview.setVisibility(View.VISIBLE);
                                }
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (data_array.length() > 0) {
                                ...
                                if (machine_obj.getString("machine_name") != null && !machine_obj.getString("machine_name").equals("")) {
                                    scrollview.setVisibility(View.VISIBLE);
                                }
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (data_array.length() > 0) {
                                ...
                                if (types_obj.getString("type_of_product") != null && !types_obj.getString("type_of_product").equals("")) {
                                    scrollview.setVisibility(View.VISIBLE);
                                }
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (data_array.length() > 0) {
                                ...
                                JSONObject district_obj = obj.getJSONObject("district");
                                JSONObject block_obj = obj.getJSONObject("block");
                                if (service_machine_obj.getString("service_machine_name") != null && !service_machine_obj.getString("service_machine_name").equals("")) {
                                    scrollview.setVisibility(View.VISIBLE);
                                }
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (data_array.length() > 0) {
                                ...
                                if (wood_type_obj.getString("wood_name") != null && !wood_type_obj.getString("wood_name").equals("")) {
                                    scrollview.setVisibility(View.VISIBLE);
                                }
