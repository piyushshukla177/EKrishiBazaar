...
public class AgricultureAdsAdapter extends RecyclerView.Adapter<AgricultureAdsAdapter.AgricultureViewHolder> {
    ...
    public AgricultureAdsAdapter(Context context, ArrayList<AgricultureAdsModel> list) {
        category_list = list;
    ...
    @NonNull
    @Override
    public AgricultureViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.cattle_ads_layout, parent, false);
        AgricultureViewHolder evh = new AgricultureViewHolder(v);
        return evh;
    }

    @Override
    public void onBindViewHolder(@NonNull final AgricultureViewHolder holder, int i) {
        ...
        holder.cardview.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(context, AdaDetailsActivity.class);
                        ...
                        intent.putExtra("price_by", currentItem.getProduct_price_by());
                        intent.putExtra("quantity_by", currentItem.getProduct_quantity_by());
