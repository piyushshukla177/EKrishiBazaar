                        ...
                        try {
                            ...
                            for (int i = 0; i < data_array.length(); i++) {
                                ...
                                if (obj.getString("type").equalsIgnoreCase("agriculturalads")) {
                                    ...
                                    JSONObject category_obj = product_obj.getJSONObject("category");
                                    m.setCategory_name(category_obj.getString("category_name"));
                                } else if (obj.getString("type").equalsIgnoreCase("fertilizerandpestisidesads")) {
                                    JSONObject product_obj = obj.getJSONObject("chemical_product");
                                    JSONObject category_obj = product_obj.getJSONObject("category");
                                    m.setCategory_name(category_obj.getString("category_name"));
                                } else if (obj.getString("type").equalsIgnoreCase("labourinrentads")) {
...
//            }
    ...
    public void MarkAsSold(String post_id) {
        final ProgressDialog mProgressDialog = new ProgressDialog(context);
        mProgressDialog.setIndeterminate(true);
        mProgressDialog.setMessage("Loading...");
        mProgressDialog.setCancelable(false);
    ...
    public void MarkCattleAsSold(String post_id) {
        final ProgressDialog mProgressDialog = new ProgressDialog(context);
        mProgressDialog.setIndeterminate(true);
        mProgressDialog.setMessage("Loading...");
        mProgressDialog.setCancelable(false);
    ...
    public void MarkFertilizerAsSold(String post_id) {
        final ProgressDialog mProgressDialog = new ProgressDialog(context);
        mProgressDialog.setIndeterminate(true);
        mProgressDialog.setMessage("Loading...");
        mProgressDialog.setCancelable(false);
    ...
    public void MarkLabourinRentAsSold(String post_id) {
        final ProgressDialog mProgressDialog = new ProgressDialog(context);
        mProgressDialog.setIndeterminate(true);
        mProgressDialog.setMessage("Loading...");
        mProgressDialog.setCancelable(false);
    ...
    public void MarkAgriMachinarytAsSold(String post_id) {
        final ProgressDialog mProgressDialog = new ProgressDialog(context);
        mProgressDialog.setIndeterminate(true);
        mProgressDialog.setMessage("Loading...");
        mProgressDialog.setCancelable(false);
    ...
    public void MarkOtherAgriProductAsSold(String post_id) {
        final ProgressDialog mProgressDialog = new ProgressDialog(context);
        mProgressDialog.setIndeterminate(true);
        mProgressDialog.setMessage("Loading...");
        mProgressDialog.setCancelable(false);
...
//                params.put("sold", "true");
    ...
    public void DeleteLabourinRentAds(String post_id) {
        final ProgressDialog mProgressDialog = new ProgressDialog(context);
        mProgressDialog.setIndeterminate(true);
        mProgressDialog.setMessage("Loading...");
        mProgressDialog.setCancelable(false);
...
//                params.put("sold", "true");
    ...
    public void DeleteAgriMachinary(String post_id) {
        final ProgressDialog mProgressDialog = new ProgressDialog(context);
        mProgressDialog.setIndeterminate(true);
        mProgressDialog.setMessage("Loading...");
        mProgressDialog.setCancelable(false);
...
//                params.put("sold", "true");
    ...
    public void DeleteOtherAgriProduct(String post_id) {
        final ProgressDialog mProgressDialog = new ProgressDialog(context);
        mProgressDialog.setIndeterminate(true);
        mProgressDialog.setMessage("Loading...");
        mProgressDialog.setCancelable(false);
...
//                params.put("sold", "true");
    ...
    public void DeleteCattleAds(String post_id) {
        final ProgressDialog mProgressDialog = new ProgressDialog(context);
        mProgressDialog.setIndeterminate(true);
        mProgressDialog.setMessage("Loading...");
        mProgressDialog.setCancelable(false);
...
//                params.put("sold", "true");
    ...
    public void DeleteFertilizerAds(String post_id) {
        final ProgressDialog mProgressDialog = new ProgressDialog(context);
        mProgressDialog.setIndeterminate(true);
        mProgressDialog.setMessage("Loading...");
        mProgressDialog.setCancelable(false);
