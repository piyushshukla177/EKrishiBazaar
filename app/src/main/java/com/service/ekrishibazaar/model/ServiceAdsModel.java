...
public class ServiceAdsModel {
    ...
    private String service_machine_name;
    ...
    public String getReaching_on_time() {
        return reaching_on_time;
    }

    public void setReaching_on_time(String reaching_on_time) {
        this.reaching_on_time = reaching_on_time;
    }
    ...
    public String getService_machine_name() {
        return service_machine_name;
    }

    public void setService_machine_name(String service_machine_name) {
