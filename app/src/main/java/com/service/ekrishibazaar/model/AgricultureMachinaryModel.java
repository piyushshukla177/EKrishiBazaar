...
public class AgricultureMachinaryModel {
    ...
    public String getMonths_in_use() {
        return months_in_use;
    }

    public void setMonths_in_use(String months_in_use) {
        this.months_in_use = months_in_use;
    }
