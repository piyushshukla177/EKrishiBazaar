...
public class OtherAgriAdsDetailActivity extends AppCompatActivity implements MakeOfferSheet.MakeOfferListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_other_agri_ads_detail);
        init();
    }
    ...
    void init() {
        ...
        back_image.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        OtherAgriAdsDetailActivity.super.onBackPressed();
                    }
                }
        );
        ...
        sliderView.setSliderAdapter(new SliderAdapterExample(OtherAgriAdsDetailActivity.this, slider_list));
        sliderView.run();
        Glide.with(context)
                .load(profile_image)
                .fitCenter()
...
//      additional_details_tv.setText(intent.getStringExtra("additional_details"));
        view_profile_btn.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(OtherAgriAdsDetailActivity.this, ViewProfileActivity.class);
        ...
        loginCall.enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, retrofit2.Response<String> response) {
                ...
                if (response.body() instanceof String) {
                    ...
                    Toast.makeText(OtherAgriAdsDetailActivity.this, x, Toast.LENGTH_SHORT).show();
                    bottomSheet.dismiss();
                }
...
//                }
            ...
            public void onFailure(@NonNull Call<String> call,
                                  @NonNull Throwable t) {
                Toast.makeText(OtherAgriAdsDetailActivity.this, "Offer is already sent", Toast.LENGTH_SHORT).show();
                if (!call.isCanceled()) {
                }
                t.printStackTrace();
            }
