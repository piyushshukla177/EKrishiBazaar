...
public class TreeAdsDetailsActivity extends AppCompatActivity implements MakeOfferSheet.MakeOfferListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tree_ads_details);
        init();
    }
    ...
    void init() {
        ...
        back_image.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        TreeAdsDetailsActivity.super.onBackPressed();
                    }
                }
        );
        ...
        sliderView.setSliderAdapter(new SliderAdapterExample(TreeAdsDetailsActivity.this, slider_list));
        sliderView.run();
        Glide.with(context)
                .load(profile_image)
                .fitCenter()
        ...
        view_profile_btn.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(TreeAdsDetailsActivity.this, ViewProfileActivity.class);
